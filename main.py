...
metar_result_string = tkinter.Label(root, justify="left", wraplength=375)
...
metar_result_string.grid(column=0, columnspan=4, row=1, sticky=tkinter.W)
...
info_label.grid(column=0, columnspan=4, row=10)
version_label.grid(column=0, columnspan=4, row=11)
root.mainloop()